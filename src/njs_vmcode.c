    ...
    njs_value_t *constructor, njs_value_t *retval)
{
    ...
    if (njs_is_object(object)) {
        ret = njs_value_property(vm, constructor,
                                 njs_value_arg(&njs_predefined.vs._prototype),
                                 &value);
...
njs_vmcode_typeof(njs_vm_t *vm, njs_value_t *value, njs_value_t *retval)
{
    ...
    static const njs_value_t  *types[NJS_VALUE_TYPE_MAX] = {
        &njs_predefined.vs._object,
        &njs_predefined.vs._undefined,
        &njs_predefined.vs._boolean,
        &njs_predefined.vs._number,
        &njs_predefined.vs._symbol,
        &njs_predefined.vs._string,
        &njs_predefined.vs._data,
        &njs_predefined.vs._external,
